                ...
                <div class="container">
                    <div class="col-md-4 bottom-content">
                        <a href=""><img src="http://localhost:81/myproject/Web2/public/frontend/images/free-shipping.png"></a>
                    </div>
                    <div class="col-md-4 bottom-content">
                        <a href=""><img src="http://localhost:81/myproject/Web2/public/frontend/images/guaranteed.png"></a>
                    </div>
                    <div class="col-md-4 bottom-content">
                        <a href=""><img src="http://localhost:81/myproject/Web2/public/frontend/images/deal.png"></a>
                    </div>
                </div>
                ...
                <section id="ft-bottom">
                    <p class="text-center">Copyright © 2019 . Design by Huan !!! </p>
                </section>
            </div>
        </div>      
    </div>
    ...
    <script  src="http://localhost:81/myproject/Web/public/frontend/js/slick.min.js"></script>
